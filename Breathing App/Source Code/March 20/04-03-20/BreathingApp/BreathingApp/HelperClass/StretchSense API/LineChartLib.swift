...
// MARK: - LINECHART CLASS
 ...
 class LineChart: UIView
 {
    ...
    var autoMinMax = true
    var max: CGFloat = 380.0
    var min: CGFloat = 280.0
...
//            if area { drawAreaBeneathLineChart(line) }
    ...
    fileprivate func drawAxes() {
        ...
        path.move(to: CGPoint(x: x.axis.inset, y: height-10))
        path.addLine(to: CGPoint(x: width - x.axis.inset, y: height-5))
        path.stroke()
        // draw y-axis
    ...
    fileprivate func drawLine(_ line: Line) {
        ...
        if line.dataStore.count != 0
        {
            ...
            var yValue = 300 - self.y.scale(data[0]) - y.axis.inset
            ...
            for index in 1..<data.count-1 {///////////////-1
                ...
                yValue = 300-self.y.scale(data[index]) - y.axis.inset
//                print("selfx",self.x.scale(CGFloat(index)), x.axis.inset)
//                print("selfy",self.y.scale(CGFloat(index)), y.axis.inset)
                ...
                print("xVal yVal",self.y.scale(data[index]), yValue)

//                print(" \(self.bounds.height) \( self.y.scale(data[index])) \(y.axis.inset)")
