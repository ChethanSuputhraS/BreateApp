...
class HomeVC: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        imgViewRecord.frame = CGRect(x: (btnWidth-30)/2, y: 12, width: 35, height: 35)
        ...
        imgViewSession.frame = CGRect(x: btnWidth + ((btnWidth-30)/2), y: 12, width: 35, height: 35)
        ...
        imgViewProfile.frame = CGRect(x: (btnWidth * 2) + ((btnWidth-30)/2)-2, y: 12, width: 35, height: 35)
        imgViewProfile.image = UIImage.init(named: "User.png")
        buttonViewBottom.addSubview(imgViewProfile)
