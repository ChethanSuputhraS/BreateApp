...
class LineChart: UIView {
    ...
    var autoMinMax = true
    var max: CGFloat = 300.0
    var min: CGFloat = 270.0
...
//            if globalData != []
//            {
//                max = globalData.max() ?? 0.0
//                min = globalData.min() ?? 0.0
//                //print("Max()",max)
//                //print("Min()",min)
            //print("DrawHeight")
...
//Next day check which method calling and flow of line in LineChartLib class and then try to ignore  all zero values for max and min
