...
//            var yValue = self.bounds.height - self.y.scale(data[0]) - y.axis.inset
            var yValue = self.bounds.height - data[0]
...
//                yValue = self.bounds.height-(self.y.scale(data[index])) * 1.5 - y.axis.inset
                yValue = self.bounds.height-(data[index])

                path.lineJoinStyle = .bevel
                print("xVal yVal", data[index],yValue)
