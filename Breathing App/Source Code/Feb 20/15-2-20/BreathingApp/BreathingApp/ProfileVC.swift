...
class ProfileVC: UIViewController,UITableViewDelegate,UITableViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        profileView.frame = CGRect(x: 0, y: 0, width: GlobalVariables.Device_Width, height: GlobalVariables.Device_Height)
            profileView.backgroundColor = UIColor.clear
            self.view.addSubview(profileView)
        
        let btnPath = UIButton()
        btnPath.frame = CGRect(x: GlobalVariables.Device_Width-60, y: 25, width: 50, height: 50)
        ...
        btnImgPath.frame = CGRect(x: 10, y: 15, width: 30, height: 30)
        ...
        tblMenu.frame = CGRect(x:20, y: GlobalVariables.Device_Height-410, width: GlobalVariables.Device_Width-40, height: GlobalVariables.Device_Height-1)
        ...
        imgViewProfileDp.frame = CGRect(x: GlobalVariables.Device_Width/2-60, y: GlobalVariables.Device_Height-600, width: GlobalVariables.Device_Width-250, height: GlobalVariables.Device_Width-250)
        imgViewProfileDp.backgroundColor = UIColor.clear
        imgViewProfileDp.image = UIImage.init(named: "userProPic.png")
        imgViewProfileDp.layer.cornerRadius = (GlobalVariables.Device_Width-250)/2
          imgViewProfileDp.clipsToBounds = true
        profileView.addSubview(imgViewProfileDp)
        
                let btnDp = UIButton()
                btnDp.frame = CGRect(x: GlobalVariables.Device_Width/2-60, y: GlobalVariables.Device_Height-600, width: GlobalVariables.Device_Width-250, height: GlobalVariables.Device_Width-250)
                btnDp.layer.cornerRadius = (GlobalVariables.Device_Width-250)/2
        ...
        if tableView == tblMenu
        {
            ...
            if indexPath.row == 6
            {
                let alert = UIAlertController(title: "Breathing App", message: "Are you Sure logout ?", preferredStyle: UIAlertController.Style.alert)
                    ...
                    Alamofire.request("http://vithamastech.com/track/mobile/logout",method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: ["token":String(format: "%@",strCurrentToken)])
                                                                                                       .responseJSON
                                                                                                       { response in
//                                                                                                          ACProgressHUD.shared.hideHUD()
