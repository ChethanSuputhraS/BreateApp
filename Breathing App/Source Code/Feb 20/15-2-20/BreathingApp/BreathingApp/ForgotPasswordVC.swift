...
class ForgotPasswordVC: UIViewController,UITextFieldDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        self.view.addSubview(btnBack)
         ...
         setUpTextField(txtField: txtRegisterdEmail, placeHolderText: "Registerd Email", yAxis: Int(GlobalVariables.Device_Height-550), boardType: .emailAddress, capitalization: .none, imgeName: "User.png")
        self.view.addSubview(txtRegisterdEmail)
        
        setUpTextField(txtField: txtRegisterPhnum, placeHolderText: "Phone ( Optional )", yAxis: Int(GlobalVariables.Device_Height-490), boardType: .emailAddress, capitalization: .none, imgeName: "User.png")
        txtRegisterPhnum.returnKeyType = .done
//        self.view.addSubview(txtRegisterPhnum)
        
        btnSubmit.frame = CGRect(x: 20, y: GlobalVariables.Device_Height-300, width: GlobalVariables.Device_Width-40, height: 50)
