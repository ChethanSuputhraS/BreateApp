...
class LogInVC: UIViewController,UITextFieldDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        LoginView.frame = CGRect(x: 0, y: 0, width: GlobalVariables.Device_Width, height: GlobalVariables.Device_Height)
        ...
        lblBreathe.frame = CGRect(x: 0, y: GlobalVariables.Device_Height-550, width: GlobalVariables.Device_Width, height: 100)
        ...
        setUpTextField(txtField: txtLogInUserName, placeHolderText: "Name", yAxis: Int(GlobalVariables.Device_Height-450), boardType: .emailAddress, capitalization: .none, imgeName: "User2x.png")
       LoginView.addSubview(txtLogInUserName)
        
        setUpTextField(txtField: txtLogInPassword, placeHolderText: "Password", yAxis: Int(GlobalVariables.Device_Height-380), boardType: .emailAddress, capitalization: .none, imgeName: "password.png")
        txtLogInPassword.isSecureTextEntry = true
        txtLogInPassword.returnKeyType = .done
        LoginView.addSubview(txtLogInPassword)
        
       
        btnRemeberMe.frame = CGRect(x: GlobalVariables.Device_Width-340, y: GlobalVariables.Device_Height-320, width: 200, height: 50)
        ...
        SetupButtons(btnAll: btnForgotPassWord, Yaxies: Int(GlobalVariables.Device_Height-270), btnTitle: "Forgot Password ?")
        ...
        SetupButtons(btnAll: btnSignIn, Yaxies: Int(GlobalVariables.Device_Height-200), btnTitle: "Sing In")
        ...
        lblDontHaveAccount.frame = CGRect(x: 0, y: GlobalVariables.Device_Height-125, width: GlobalVariables.Device_Width, height: 50)
        ...
        SetupButtons(btnAll: btnSignUp, Yaxies: Int(GlobalVariables.Device_Height-80), btnTitle: "Sign up")
          btnSignUp.addTarget(self, action: #selector(btnSignUpClick), for: .touchUpInside)
        LoginView.addSubview(btnSignUp)
        
  //MARK: - Sign up View
        
        signUpView.frame = CGRect(x: 0, y: 0, width: GlobalVariables.Device_Width, height: GlobalVariables.Device_Height)
        ...
        signUpView.addSubview(lblSignUp)
         ...
         setUpTextField(txtField: txtUserName, placeHolderText: "Name", yAxis: Int(GlobalVariables.Device_Height-550), boardType: .emailAddress, capitalization: .none, imgeName: "User2x.png")
        txtUserName.returnKeyType = .next
        signUpView.addSubview(txtUserName)
        
         setUpTextField(txtField: txtEmailSignUp, placeHolderText: "E mail", yAxis: Int(GlobalVariables.Device_Height-490), boardType: .emailAddress, capitalization: .none, imgeName: "User2x.png")
        txtEmailSignUp.returnKeyType = .next
        signUpView.addSubview(txtEmailSignUp)
        
         
         setUpTextField(txtField: txtPasswordSignUp, placeHolderText: "Password", yAxis: Int(GlobalVariables.Device_Height-430), boardType: .emailAddress, capitalization: .none, imgeName: "password.png")
         txtPasswordSignUp.isSecureTextEntry = true
         txtPasswordSignUp.returnKeyType = .next
         signUpView.addSubview(txtPasswordSignUp)
        
        setUpTextField(txtField: txtConfirmPassword, placeHolderText: "Confirm Password", yAxis: Int(GlobalVariables.Device_Height-370), boardType: .emailAddress, capitalization: .none, imgeName: "password.png")
        txtConfirmPassword.isSecureTextEntry = true
        txtConfirmPassword.returnKeyType = .done
        signUpView.addSubview(txtConfirmPassword)
        
        
        btnTermsAdnCondition.frame = CGRect(x: GlobalVariables.Device_Width-340, y: GlobalVariables.Device_Height-320, width: GlobalVariables.Device_Width, height: 50)
        ...
        SetupButtons(btnAll: btnSubmit, Yaxies: Int(GlobalVariables.Device_Height-200), btnTitle: "Submit")
                       btnSubmit.addTarget(self, action: #selector(btnSubmitClick), for: .touchUpInside)
        signUpView.addSubview(btnSubmit)
        
        SetupButtons(btnAll: btnHaveAccount, Yaxies: Int(GlobalVariables.Device_Height-100), btnTitle: "Have account? Sign in")
...
// MARK: - TextFiledMethod
    ...
    {
        txtField.frame = CGRect(x: 20, y: yAxis, width: Int((GlobalVariables.Device_Width)-40), height: 50)
...
func textFieldShouldReturn(_ textField: UITextField) -> Bool
    ...
    {
        btnAll.frame = CGRect(x: 20, y: Yaxies, width: Int(GlobalVariables.Device_Width-40), height: 50)
