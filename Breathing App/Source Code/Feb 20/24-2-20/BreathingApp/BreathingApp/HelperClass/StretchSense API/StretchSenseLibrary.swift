    ...
    {
        var cbCharcteristiccss : CBCharacteristic!
...
//            peripheral.discoverServices(nil)
        ...
        func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
            ...
            {
                if charateristic.uuid.uuidString == "00001705-7374-7265-7563-6873656E7365"
                {
//                                        var parameter = NSInteger(2)
//                                        let data = NSData(bytes: &parameter, length: 1)
//                                        peripheral.writeValue(data as Data, for: charateristic, type: .withResponse)
//                                        print("sent data is ",data)

                }
                if charateristic.uuid.uuidString == "00001702-7374-7265-7563-6873656E7365"
                {
                    cbCharcteristiccss = charateristic
                }
//
...
//            print(characteristic.uuid.uuidString)
            if characteristic.uuid.uuidString == "00001705-7374-7265-7563-6873656E7365"
            {
                print("ValueData", characteristic)
                (peripheral.setNotifyValue(true, for: cbCharcteristiccss))
//                peripheral.readValue(for: cbCharcteristiccss)
...
//                peripheral.readValue(for: cbCharcteristiccss)
        ...
        func didUpdateValueGenTako(_ peripheral: CBPeripheral, characteristic: CBCharacteristic){
            ...
            if characteristic.uuid == CBUUID(string: "00601050-7374-7265-7563-6873656e7365") {
...
//                            print("nSensorInCaracteristic",nSensorInCaracteristic)
...
/*
     ...
     /*                    let tmpData = NSData(bytes: [0x02] as [UInt8], length: 1)
     peripheral.writeValue(tmpData as Data, for: charateristic, type: .withResponse)
     print("sent data is ",tmpData)*/
     //            00001705-7374-7265-7563-6873656E7365
     
     //                    var parameter = NSInteger(100)
     //                    let data = NSData(bytes: &parameter, length: 1)
     //                    peripheral.writeValue(data as Data, for: charateristic, type: .withResponse)
     //                    print("sent data is ",data)
