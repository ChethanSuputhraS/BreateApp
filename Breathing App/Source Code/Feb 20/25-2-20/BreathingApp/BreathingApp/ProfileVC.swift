...
class ProfileVC: UIViewController,UITableViewDelegate,UITableViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        tblMenu.frame = CGRect(x:20, y: constants.heighs-410, width: constants.widths-40, height: constants.heighs-1)
        ...
        var hPr = CGFloat(constants.heighs-600)
        ...
        imgViewProfileDp.frame = CGRect(x: constants.widths/2-80, y: hPr, width: constants.widths-250, height: constants.widths-250)
        ...
        var hPrBtn = CGFloat(constants.heighs-600)
        if (constants.IS_IPHONE_X)
        {
            hPrBtn = hPrBtn - 200
        }
                ...
                let btnDp = UIButton()
                btnDp.frame = CGRect(x: constants.widths/2-80, y: hPrBtn, width: constants.widths-250, height: constants.widths-250)
