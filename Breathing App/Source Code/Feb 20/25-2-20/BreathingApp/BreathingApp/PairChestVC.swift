...
//                if arrDevices[i]?.state == CBPeripheralState.disconnected
//                {
...
//        stretchsenseObject.connectToPeripheralWithUUID(strAbdUUID as String)
