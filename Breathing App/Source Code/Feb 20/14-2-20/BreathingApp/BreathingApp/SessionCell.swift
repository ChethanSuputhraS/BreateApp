...
class SessionCell: UITableViewCell
{
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?)
    {
        ...
        lblDate.frame = CGRect(x: 10, y: 0, width: GlobalVariables.Device_Width, height: 50)
        lblDate.textColor = UIColor.white
        self.contentView.addSubview(lblDate)
        
        lblTime.frame = CGRect(x: GlobalVariables.Device_Width-100, y: 0, width: GlobalVariables.Device_Width-100, height: 50)
