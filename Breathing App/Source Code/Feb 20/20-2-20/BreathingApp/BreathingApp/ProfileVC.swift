...
class ProfileVC: UIViewController,UITableViewDelegate,UITableViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        imgViewProfileDp.frame = CGRect(x: constants.widths/2-60, y: constants.heighs-600, width: constants.widths-250, height: constants.widths-250)
        ...
        profileView.addSubview(imgViewProfileDp)
                ...
                let btnDp = UIButton()
                btnDp.frame = CGRect(x: constants.widths/2-60, y: constants.heighs-600, width: constants.widths-250, height: constants.widths-250)
